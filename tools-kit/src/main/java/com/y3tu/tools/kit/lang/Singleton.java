...
public final class Singleton {
    ...
    public static <T> T get(String className, Object... params) {
        Assert.notNull(className, "Class name must be not null !");
        final Class<T> clazz = ClassUtil.loadClass(className, true);
    ...
    private static String buildKey(String className, Object... params) {
        if (ArrayUtil.isEmpty(params)) {
            ...
            return String.format("%s#%s", className, String.join("_", list));
        }
    }
}
